...
public class PointJavi {
    ...
    public PointJavi(byte x, byte y, String colour, char symbol) {
        ...
        //Otra forma   this.x = (x <0) ? 0 : (x > 12)? 12: x;
    ...
    public PointJavi(byte x, byte y){
        this(x, y, "black", '*');
    }

    public PointJavi(String colour, char symbol){
        this((byte)0, (byte)0, colour, symbol);
    }

    public PointJavi(PointJavi p){
